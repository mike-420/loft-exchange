...
const Subscribe = () => {
  return (
    <section className="pt-[164px] pb-[122px] max-w-screen-1440px mx-auto flex items-center justify-center flex-col gap-3.5">
      <h1
      ...
      <div className="mt-4">
        <div className="grid grid-cols-4 max-w-[870px] gap-2.5 mx-auto">
          <input
            type="text"
